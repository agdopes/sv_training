...
struct gpio_hal_interface {
     ...
     */
    uint8_t (*init)(uint32_t instance, uint32_t pin, uint32_t pin_config);
     ...
     * @param instance GPIO pin number
     */
    void (*deinit)(uint32_t instance,uint32_t pin);
     ...
     * @return GPIO_OK on success, error code otherwise
     */
    uint8_t (*pin_set)(uint32_t instance, uint32_t pin, uint32_t pin_val);
     ...
     * @return GPIO_OK on success, error code otherwise
     */
    uint8_t (*pin_read)(uint32_t instance, uint32_t pin, uint32_t *pin_value);
 ...
 */
static inline uint8_t hal_gpio_init(uint32_t instance, uint32_t pin, uint32_t pin_config) {
    return hal_gpio_get_interface()->init(instance, pin, pin_config);
}
 ...
 * @param instance GPIO pin number
 */
static inline void hal_gpio_deinit(uint32_t instance,uint32_t pin) {
    hal_gpio_get_interface()->deinit(instance, pin);
}
 ...
 * @return GPIO_OK on success, error code otherwise
 */
static inline uint8_t hal_gpio_pin_set(uint32_t instance, uint32_t pin, uint32_t pin_val) {
	return hal_gpio_get_interface()->pin_set(instance, pin, pin_val);
}
 ...
 * @return GPIO_OK on success, error code otherwise
 */
static inline uint8_t hal_gpio_pin_read(uint32_t instance, uint32_t pin, uint32_t *pin_val) {
	return hal_gpio_get_interface()->pin_read(instance, pin, pin_val);
}
